...
const PROD_PATH = 'https://hijrah.citapen.com/'
const title =
  "Hijrah dari browser "
...
const config = {
  ...
  head: {
    ...
    noscript: [
      {
        innerHTML: 'Hijrah membutuhkan JavaScript agar berjalan dengan baik.',
        body: true
      }
    ],
    script: [
  ...
  pwa: {
    workbox: {
      ...
      runtimeCaching: [
        {
          urlPattern: 'https://hijrah.citapen.com/tulisan/.*',
          handler: 'NetworkFirst'
        },
        {
          urlPattern: 'https://hijrah.citapen.com/stories/.*',
          handler: 'NetworkFirst'
        },
        {
          urlPattern: 'https://hijrah.citapen.com/assets/.*',
          handler: 'CacheFirst',
          strategyOptions: {
